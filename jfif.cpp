...
void* jfif_encode(BMP *pb)
{
	...
	jfif->pqtab[0] = (int*)malloc(64 * sizeof(int));
	jfif->pqtab[1] = (int*)malloc(64 * sizeof(int));
	jfif->phcac[0] = (HUFCODEC*)calloc(1, sizeof(HUFCODEC));
	jfif->phcac[1] = (HUFCODEC*)calloc(1, sizeof(HUFCODEC));
	jfif->phcdc[0] = (HUFCODEC*)calloc(1, sizeof(HUFCODEC));
	jfif->phcdc[1] = (HUFCODEC*)calloc(1, sizeof(HUFCODEC));
...
#pragma omp parallel for num_threads(ParallelHelp::ThreadCount()) shared(pb) firstprivate(bsrc, ydst, udst, vdst, firstLoop)
